...
describe SlotsController do
  ...
  let(:valid_attributes) { { "possible_downloads" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved slot as @slot" do
        ...
        post :create, {:slot => { "possible_downloads" => "invalid value" }}, valid_session
        assigns(:slot).should be_a_new(Slot)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested slot" do
        ...
        Slot.any_instance.should_receive(:update).with({ "possible_downloads" => "1" })
        put :update, {:id => slot.to_param, :slot => { "possible_downloads" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the slot as @slot" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Slot.any_instance.stub(:save).and_return(false)
        put :update, {:id => slot.to_param, :slot => { "possible_downloads" => "invalid value" }}, valid_session
        assigns(:slot).should eq(slot)
      end
